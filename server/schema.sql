...
create table if not exists assessment_login_attempts (
...
create index if not exists assessment_submissions_session_time_idx
  on assessment_submissions(session_id, submitted_at);
create index if not exists assessment_submissions_report_token_idx
